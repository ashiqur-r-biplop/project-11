  ...
  return (
    <div className="navbar bg-white fixed top-0 z-[500]">
      ...
      <div className="navbar-end flex gap-5 text-lg">
        <Link to="/register" className="underline text-black hover:text-[#05264e]">
          Register
        </Link>
        <Link to="/login" className="btn btn-xs sm:btn-sm md:btn-md bg-[#3c65f5] hover:bg-[#05264e] text-white border-none">
          Sign In
        </Link>
      </div>
    </div>
