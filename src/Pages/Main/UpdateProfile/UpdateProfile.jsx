...
const UpdateProfile = () => {
  ...
  const handleUpdate = (e) => {
    ...
    const updateProfile = { name,email,field, age, experience, location, country, phone, skills, logo,education,accomplishments,certificate, description, selery }
    console.log(updateProfile)
  }
  return (
    <div className="max-w-screen-xl mx-auto bg-blue-50 m-6 rounded">

      <img className="w-full  md:h-[500px]" src="https://t3.ftcdn.net/jpg/06/39/62/90/240_F_639629017_YjfnLtEGhYsnXr9GlyXf6dXwLVmVdaRW.jpg" alt="" />
      <h1 className="text-4xl text-center  font-bold text-blue-500 md:text-white md:-mt-72 m-4 rounded">Profile Update</h1>
            ...
            <div className="grid grid-cols-1  md:grid-cols-2  mx-auto md:gap-x-12">
              ...
              <div className="form-control">
                ...
                <div className="input-group">
                  <select name="field" className="select select-bordered border-sky-500 input-info w-full mb-2">
              ...
              <div className="form-control">
                ...
                <div className="input-group">
                  <select name="selery" className="select select-bordered border-sky-500 input-info w-full mb-2">
                    <option disabled selected>Pick category</option>
              ...
              <div className="form-control">
                ...
                <div className="input-group">
                  <select name="skills" className="select select-bordered border-sky-500 input-info w-full mb-2">
                    <option disabled selected>Pick category</option>
                    <option>User Interfact Design</option>
                    <option>UI</option>
                    <option>UX</option>
                    <option>Adobe XD</option>
                    <option>Mobile Apps</option>
                    <option>User Reaserch</option>
              ...
              <div>
                ...
                <textarea className="border border-sky-500 w-full rounded" placeholder="Write Description" name="description" id="" cols="" rows="5"></textarea>
              </div>
              </div>
            </div>
            <div className="form-control mt-6">
                <input className="btn btn-block  bg-blue-500 hover:bg-blue-700 text-white" type="submit" value='Update' name="" id="" />
              </div>
          </form>
        </div>
