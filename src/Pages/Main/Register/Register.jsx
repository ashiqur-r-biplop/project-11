...
<div>
  <h1 className="text-5xl font-bold mb-8 text-center text-sky-500 mt-10 md:mt-20">Register now!</h1>
<div className="hero-content flex-col lg:gap-16 lg:flex-row ">
  <div className="text-center lg:text-left">
    <img className="md:h-[660px]" src='https://img.freepik.com/free-vector/access-control-system-abstract-concept_335657-3180.jpg?size=626&ext=jpg&uid=R76180397&ga=GA1.1.110381157.1659454590&semt=ais' alt="" />
  </div>
  ...
  <form onSubmit={handleRegister} className='p-4 ' >
            ...
            <input type="text" placeholder="Your Name" name="name" className="input input-bordered border-sky-500 input-info w-full max-w-xs mb-2" required/>
            <p className='text-lg'>Photo URL:</p>
            <input type="url" placeholder="Image URL" name="photo" className="input input-bordered border-sky-500 input-info w-full max-w-xs mb-2" required/>
            <p className='text-lg'>Your Email:</p>
            <input type="email" placeholder="Enter email" name="email" className="input input-bordered border-sky-500 input-info w-full max-w-xs mb-2" required/>
            <p className='text-lg'>Password:</p>
            <input type={show ? "text" : "password"} placeholder="Enter password" name="password" className="input input-bordered border-sky-500 input-info w-full max-w-xs mb-2" required/>
            ...
            <input className='bg-sky-500 hover:bg-sky-800 px-12 py-3 rounded font-bold text-white btn btn-block max-w-xs mt-2' type="submit" name="login" value="Register" id="" />
            <br />
